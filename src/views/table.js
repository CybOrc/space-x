        ...
        return (
          ...
          <div className="c-rocket-table__row">
              <div className="c-rocket-table__cell">
                <button type="button" data="name" onClick={ this.handleClick }> Name </button>
              </div>
              <div className="c-rocket-table__cell">
                <button type="button" data="active" onClick={ this.handleClick }> Status </button>
              </div>
              <div className="c-rocket-table__cell">
                <button type="button" data="success_rate_pct" onClick={ this.handleClick }> Success </button>
              </div> 
              <div className="c-rocket-table__cell">
                <button type="button" data="stages" onClick={ this.handleClick }> Stages </button>
              </div> 
              <div className="c-rocket-table__cell">
                <button type="button" data="boosters" onClick={ this.handleClick }> Boosters </button>
              </div> 
              <div className="c-rocket-table__cell">
                <button type="button" data="first_flight" onClick={ this.handleClick }> First Flight </button>
              </div> 
              <div className="c-rocket-table__cell">
                Details
              </div>                  
