...
class Details extends React.Component {
  ...
  render() {
    ...
    const rocketDetails = data.filter((obj) => {
      return obj.id === rocketId;
    })[0];
    ...
    const launchesTableHeader = (
      <div className="c-rocket-table__row">
        <div className="c-rocket-table__cell">
          <button type="button" data="date_utc" onClick={this.handleClick}>
            Date
          </button>
        </div>
        <div className="c-rocket-table__cell">
          <button type="button" data="success" onClick={this.handleClick}>
            Status
          </button>
        </div>
        ...
        <section>
          <div className="o-layout">
            <div className="o-layout__item u-1/2">
              ...
              <ul>
                <li className="o-layout__item u-1/2  u-padding-none">
                  Height: {rocketDetails.height.meters}m
                </li>
                <li className="o-layout__item u-1/2  u-padding-none">
                  Diameter: {rocketDetails.diameter.meters}m
                </li>
                <li className="o-layout__item u-1/2  u-padding-none">
                  Mass: {rocketDetails.mass.kg}
                </li>
                <li className="o-layout__item u-1/2  u-padding-none">
                  Engine: {rocketDetails.engines.type}
                </li>
                <li className="o-layout__item u-1/2  u-padding-none">
                  Wikipedia: <a href={rocketDetails.wikipedia}>here</a>{" "}
                </li>
              </ul>
            </div>
            <div className="o-layout__item u-1/2">
          ...
          <div className="c-rocket-table">
            ...
            {sortedLaunches.length > 0 ? (
              ...
              <p className="u-margin-horizontal">
                This vessel has yet to peform any launches
              </p>
            )}
